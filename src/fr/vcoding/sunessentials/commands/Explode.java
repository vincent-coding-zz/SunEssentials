	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(sender instanceof Player) {
			...
			if(victim !=null && victim.isOnline()) {
				Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "summon minecraft:tnt " + victim.getLocation().getBlockX() + " " + victim.getLocation().getBlockY() + " " + victim.getLocation().getBlockZ());
				Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "summon minecraft:tnt " + victim.getLocation().getBlockX() + " " + victim.getLocation().getBlockY() + " " + victim.getLocation().getBlockZ());
				Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "summon minecraft:tnt " + victim.getLocation().getBlockX() + " " + victim.getLocation().getBlockY() + " " + victim.getLocation().getBlockZ());
				Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "summon minecraft:tnt " + victim.getLocation().getBlockX() + " " + victim.getLocation().getBlockY() + " " + victim.getLocation().getBlockZ());
				Bukkit.getServer().dispatchCommand(Bukkit.getServer().getConsoleSender(), "summon minecraft:tnt " + victim.getLocation().getBlockX() + " " + victim.getLocation().getBlockY() + " " + victim.getLocation().getBlockZ());
